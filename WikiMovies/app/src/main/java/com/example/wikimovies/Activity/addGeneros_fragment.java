...
public class addGeneros_fragment extends AppCompatActivity{
    List<String> seleccionados= new ArrayList<>();
    TextView seleccionadosLabel;
    private addGeneros_fragment.addGenerosTask mAuthTask= null;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_add_generos);
    ...
    public class addGenerosTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(existeUsuario){
                if(DataController.getInstance().deleteGeneros()){
                    respuesta=DataController.getInstance().addGeneros(seleccionados);
                }
            }else{
                respuesta=DataController.getInstance().addGeneros(seleccionados);
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent intent = new Intent(addGeneros_fragment.this, MainActivity.class);
